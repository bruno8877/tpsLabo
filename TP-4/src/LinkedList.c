    ...
    if(this != NULL && index >=0 && index < ll_len(this))
    {
        ...
        if(nuevoNodo!= NULL)
        {
            ...
            else
            {
                ...
                if(Anterior !=NULL)
                {
                    Anterior->pNextNode = nuevoNodo->pNextNode;
                    this->size--;
                    free(nuevoNodo);
                    returnAux =0;
...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
    ...
    if(this != NULL && this2 != NULL)
    {
        ...
        for(int i =0; i<tam; i++) //recorro this2
        {
            ...
            {
                returnAux =0;
                break; //busco la falla si la encuentro salgo
            }
        }
    }
...
LinkedList* ll_subList(LinkedList* this,int from,int to)
{
    ...
    if( !(this==NULL || from < 0 || from > ll_len(this) ||to<= from || to> ll_len(this) ) ) //Entro al if cuando los datos son invalidos, si no entra al if retorna null
    {
...
LinkedList* ll_clone(LinkedList* this)
{
    ...
    if(this != NULL)
    {
        cloneArray = ll_subList(this, 0, ll_len(this));//desde 0 hasta el tam de this
    }
