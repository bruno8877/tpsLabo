    ...
    do
    {
        ...
        switch(opcion)
        {
            ...
            case 4: //Muestro los resultados de las operaciones realizadas
                    ...
                    printf("\nEl resultado de la suma es(A+B): %.2f\n", ResultadoSuma);
                    printf("\nEl resultado de la resta es(A-B): %.2f\n", ResultadoResta);
                    ...
                    {
                        printf("\nEl resultado de la division es(A/B): %.2f\n", ResultadoDivision);
                    }


                    printf("\nEl resultado de la multiplicacion es(A*B): %.2f\n", ResultadoMultiplicacion);
                    ...
                    {
                        printf("\nEl resultado del factorial numero 1 ingresado es(A!): %d\n", ResultadoFactoreo1);
                    }
                    if(num2 <0)
                    {
                        printf("\nNo se puede factorear un numero negativo\n\n");
                    ...
                    {
                        printf("\nEl resultado del factorial numero 2 ingresado es(B!): %d\n\n", ResultadoFactoreo2);
                    }
